...
Esta última versão é a unificação do nosso código com o do grupo B
...
def register_product():
    ...
    product = {"code": code, "name": name, "price": price, "stock": stock}
...
def export_csv():
    ...
    print(f"Relatório exportado com sucesso para: {csv_file}")
